...
3. The "Balance & Tracking" sheet is composed of there tables and one graphic, all of them are connected:
    ...
    * The Account table provides information about different Accounts and their current values. The cell C13 calculates the difference between the total Accounts (C9:C12) and the Balance of the month B5. Ideally, this value should be $0, indicating alignment between the sheet and the Accounts.
